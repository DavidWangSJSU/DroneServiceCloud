...
import DeleteMissions from "./scenes/deleteMissions";
...
import GetAllUsers from "./scenes/viewUsers";
...
export function ViewMissionPlanner(props) {
console.log("params: ", props.params);
  const [theme, colorMode] = useMode();
  const [isSidebar, setIsSidebar] = useState(true);
  const location = useLocation();
  const { serviceType, droneId, tenantId, missionId, waypointItems } = location.state || { serviceType: '', droneId: '', tenantId: '', missionId: '', waypointItems: [] };
        ...
        <div className="app3">
          <div className="main-container">
            ...
            <div className="content-container">
              ...
              <main className="content">
                <Routes>
                  <Route path="/" element={<MissionPlanner serviceType={serviceType} droneId={droneId} tenantId={tenantId} missionId={missionId} waypointItems={waypointItems}/>} />
                </Routes>
              </main>
            </div>
          </div>
...
export function DeleteMissionsPage() {
  const [theme, colorMode] = useMode();
  const [isSidebar, setIsSidebar] = useState(true);
        ...
        <div className="app3">
          <div className="main-container">
            ...
            <div className="content-container">
              ...
              <main className="content">
                <Routes>
                  <Route path="/" element={<DeleteMissions />} />
                </Routes>
              </main>
            </div>
          </div>
